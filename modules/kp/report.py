...
class Report(QState):
    ...
    def onEntry(self, event: QEvent) -> None:
        ...
        ctrl.report.create_report('КП 106', ctrl.report_header.dev_num, ctrl.report_header.date)
    ...
    def header(self):
        ...
        self.pos = (45, 15)
        self.draw_text(f'испытания клапана пневматического КП 106 № {ctrl.report_header.dev_num}')
        self.pos = (15, 25)
    ...
    def pressure(self):
        self.cell('Давление срабатывания КП 106, МПа', '0,20-0,25', f'{ctrl.kp.text_p()}')

    def fill(self):
        self.cell('Время наполнения ТЦ2 с 0 до 0,35 МПа, с',
                  'не более 4', f'{ctrl.kp.text_t()}')
